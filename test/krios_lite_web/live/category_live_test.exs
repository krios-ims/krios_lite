defmodule KriosLiteWeb.CategoryLiveTest do
  use KriosLiteWeb.ConnCase

  import Phoenix.LiveViewTest
  import KriosLite.CategoriesFixtures

  @create_attrs %{name: "some_name", description: "some descrption"}
  @update_attrs %{name: "some_updated_name", description: "some_updated_description"}
